...
$sql_ins=mysqli_query($c,"INSERT INTO sub_tbl 
	VALUES(
		NULL,
		'$fa_name',
		'$teach_name' ,
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($c,"UPDATE sub_tbl SET
		faculties_id='$fac_id' ,
		teacher_id='$tea_id' ,
		semester='$semester' ,
		sub_name='$sub_name' ,
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($c,"SELECT * FROM sub_tbl WHERE sub_id=$id");
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="techtxt" class="form-control">
                            <?php
                            $te_name=mysqli_query($c,"SELECT * FROM teacher_tbl");
