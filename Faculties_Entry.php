...
$sql_ins=mysqli_query($c,"INSERT INTO facuties_tbl 
						VALUES(
							NULL,
							'$facuties_name',
							'$note'
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($c,"UPDATE facuties_tbl SET 
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($c,"SELECT * FROM facuties_tbl WHERE faculties_id=$id");
