...
$sql_ins=mysqli_query($c,"INSERT INTO stu_score_tbl 
						VALUES(
							NULL,
							'$stu_name',
							'$fa_name' ,
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($c,"UPDATE stu_score_tbl SET
							stu_id='$stu_id' ,
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($c,"SELECT * FROM stu_score_tbl WHERE ss_id=$id");
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="sudenttxt" class="form-control">
                            <?php
                            $student_name=mysqli_query($c,"SELECT * FROM stu_tbl");
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="factxt" class="form-control">
                            <?php
                            $fac_name=mysqli_query($c,"SELECT * FROM facuties_tbl");
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="subjecttxt" class="form-control">
                            <?php
                            $subject=mysqli_query($c,"SELECT * FROM sub_tbl");
